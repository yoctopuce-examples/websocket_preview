...
//--- (YPowerOutput definitions)
    ...
    {
        YPowerOutput obj;
        obj = (YPowerOutput) YFunction._FindFromCache(YAPI.GetYCtx(), "PowerOutput", func);
        if (obj == null) {
            obj = new YPowerOutput(YAPI.GetYCtx(), func);
    ...
    public YPowerOutput nextPowerOutput()
    {
        ...
        return FindPowerOutput(next_hwid, _yapi);
    }
     ...
     * @return a YPowerOutput object allowing you to drive the power ouput control.
     */
    public static YPowerOutput FindPowerOutput(String func, YAPIContext yapi_obj)
    {
        YPowerOutput obj;
        obj = (YPowerOutput) YFunction._FindFromCache(yapi_obj, "PowerOutput", func);
        if (obj == null) {
            obj = new YPowerOutput(yapi_obj, func);
            YFunction._AddToCache("PowerOutput", func, obj);
        }
        return obj;
    }
    ...
    public static YPowerOutput FirstPowerOutput()
    {
        ...
        if (next_hwid == null)  return null;
        return FindPowerOutput(next_hwid, yctx);
    }
     ...
     *         if there are none.
     */
    public static YPowerOutput FirstPowerOutput(YAPIContext yapi)
    {
        String next_hwid = yapi._yHash.getFirstHardwareId("PowerOutput");
        if (next_hwid == null)  return null;
        return FindPowerOutput(next_hwid, yapi);
    }
