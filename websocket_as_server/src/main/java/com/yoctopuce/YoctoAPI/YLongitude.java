...
//--- (YLongitude definitions)
    ...
    {
        YLongitude obj;
        obj = (YLongitude) YFunction._FindFromCache(YAPI.GetYCtx(), "Longitude", func);
        if (obj == null) {
            obj = new YLongitude(YAPI.GetYCtx(), func);
    ...
    public YLongitude nextLongitude()
    {
        ...
        return FindLongitude(next_hwid, _yapi);
    }
     ...
     * @return a YLongitude object allowing you to drive the longitude sensor.
     */
    public static YLongitude FindLongitude(String func, YAPIContext yapi_obj)
    {
        YLongitude obj;
        obj = (YLongitude) YFunction._FindFromCache(yapi_obj, "Longitude", func);
        if (obj == null) {
            obj = new YLongitude(yapi_obj, func);
            YFunction._AddToCache("Longitude", func, obj);
        }
        return obj;
    }
    ...
    public static YLongitude FirstLongitude()
    {
        ...
        if (next_hwid == null)  return null;
        return FindLongitude(next_hwid, yctx);
    }
     ...
     *         if there are none.
     */
    public static YLongitude FirstLongitude(YAPIContext yapi)
    {
        String next_hwid = yapi._yHash.getFirstHardwareId("Longitude");
        if (next_hwid == null)  return null;
        return FindLongitude(next_hwid, yapi);
    }
